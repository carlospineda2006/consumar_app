...
//Cargar la lista completa de todos los Dr y sus detalles
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            onChanged: (value) {
                              idVehicleDr = int.parse(codigoQrController.text);
                              idServiceOrder =
                              ...
                              children: [
                                ...
                                DropdownButtonFormField(
                                  decoration: InputDecoration(
                                    ...
                                    labelText: 'Third Parties in the Operation',
                                    labelStyle: TextStyle(
                                      color: kColorAzul,
                                      fontSize: 20.0,
                                    ),
                                  ...
                                  onChanged: (value) => {
                                    ...
                                    if (_selectTercerosOperation == "OTHERS")
                                      {
                                        setState(() {
                                          isVisibleOtherPartieOperation = true;
                                        }),
                                      }
                                    else
                                ...
                                DropdownButtonFormField(
                                  ...
                                  onChanged: (value) => {
                                    setState(() {
                                      ...
                                      //_desplegableDano = (value!=null ? value: '');
                                    }),
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      TextFormField(
                                        ...
                                        controller: cantidadFaltanteController,
                                      ),
                                    ],
                                  ),
                                ),
                                  ...
                                  if (damageList.length <
                                    ...
                                    if (isVisible2 == false) {
                                      if (ingnoreZone == false) {
                                        ...
                                        if (_desplegableParte == 'Others') {
                                          menuParteVeh =
                                              _otherPartVehicleController.text;
                                        } else {
                                          menuParteVeh = _desplegableParte;
                                        }
                              ...
                              child: DataTable(
                                ...
                                rows: damageList
                                  ...
                                  return DataRow(cells: <DataCell>[
                                    ...
                                    DataCell(
                                        Text(damageItem.descripcionFaltantes!)),
                                    DataCell(IconButton(
                                    ...
                                    if (_damageInformation !=
                                      ...
                                      if (damageList.length ==
                                        ...
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(const SnackBar(
                                          content:
                                              Text("Falta daños por registrar"),
                                          backgroundColor: Colors.redAccent,
                                        ));
                                      }
                                    } else {
                                      ...
                                      .map(((e) => DataRow(
                                            cells: <DataCell>[
                                              ...
                                              /* DataCell(Text(
                                                      ...
                                                      textAlign:
                                                          TextAlign.center)), */
                                              DataCell(Text(e.chasis.toString(),
                                                  textAlign: TextAlign.center)),
  ...
  clearDamageReportForm() {
    ...
    codigoQrController.text = '';
    chasisBusquedaController.clear();
