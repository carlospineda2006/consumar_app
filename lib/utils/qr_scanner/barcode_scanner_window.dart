...
import 'package:consumar_app/utils/qr_scanner/scanner_error_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.pop(context, this.barcode?.displayValue!);
        },
                    ...
                    children: [
                      Center(
                        child: SizedBox(
                          ...
                          child: FittedBox(
                            child: Text(
                              barcode?.displayValue ?? 'Escanea el codigo QR',
